        ...
        <Dialog>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div><Label>{t('services.price')}</Label><Input type="number" className="mt-1.5" /></div>
            ...
            <Card key={s.id} className="hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <StatusBadge status={s.active ? 'active' : 'inactive'} label={s.active ? t('common:active', { ns: 'common' }) : t('common:inactive', { ns: 'common' })} />
                </div>
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                  ...
                  {s.price && <span className="flex items-center gap-1"><DollarSign className="h-3.5 w-3.5" /> ${s.price}</span>}
                </div>
              </CardContent>
            </Card>
          ))}
